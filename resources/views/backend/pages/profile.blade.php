              ...
              <table class="table table-striped">
                <tbody class="table-border-bottom-0">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      <input class="form-check-input" type="radio" name="bahasaDefault" value="id" checked>
        ...
        <div class="card">
          <form action="/dashboard/setting-profile-edit" method="post">
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-striped">
                <tbody class="table-border-bottom-0">
                  @foreach($dataProfilEn as $profilEn)
                  @endforeach
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Bahasa</strong></td>
                    <td>:</td>
                    <td>
                      <input class="form-check-input" type="radio" name="bahasaDefault" value="en" checked>
                  ...
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Nama Perusahaan</strong></td>
                    <td>:</td>
                    <td><input type="hidden" name="id" value="{{ $profilEn->id }}"><input type="text" class="form-control" placeholder="Nama Perusahaan" name="nama_perusahaan" value="{{ $profilEn->nama_perusahaan }}"></td>
                  </tr>
                  
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Lokasi</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Lokasi" name="lokasi" value="{{ $profilEn->lokasi }}"></td>
                  </tr>
                  
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Kode Pos</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Kode Pos" name="kodepos" value="{{ $profilEn->kodepos }}"></td>
                  </tr>
                  
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Provinsi</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Provinsi" name="provinsi" value="{{ $profilEn->provinsi }}"></td>
                  </tr>
                  
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Negara</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Negara" name="negara" value="{{ $profilEn->negara }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Telepon</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Telepon" name="telp" value="{{ $profilEn->telp }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Fax</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Provinsi" name="fax" value="{{ $profilEn->fax }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Website</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Website" name="website" value="{{ $profilEn->website }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Email</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Email" name="email" value="{{ $profilEn->email }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Kontak</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Kontak" name="kontak" value="{{ $profilEn->kontak }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Tahun Didirikan</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Tahun Didirikan" name="tahun_didirikan" value="{{ $profilEn->tahun_didirikan }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Sektor Bisnis</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Sektor Bisnis" name="sektor_bisnis" value="{{ $profilEn->sektor_bisnis }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Bahasa</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Bahasa" name="bahasa" value="{{ $profilEn->bahasa }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Produk Utama</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Produk Utama" name="produk_utama" value="{{ $profilEn->produk_utama }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Merek</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Kontak" name="merek" value="{{ $profilEn->merek }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Volume</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Volume" name="volume" value="{{ $profilEn->volume }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Spesifikasi</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Spesifikasi" name="spesifikasi" value="{{ $profilEn->spesifikasi }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Komposisi Bahan</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Komposisi Bahan" name="komposisi_bahan" value="{{ $profilEn->komposisi_bahan }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Harga dan Jangka</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Harga dan Jangka" name="harga_jangka" value="{{ $profilEn->harga_jangka }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Pemesanan Minimal</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Pemesanan Minimal" name="minimum_order" value="{{ $profilEn->minimum_order }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Validitas Harga</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Validitas Harga" name="validitas_harga" value="{{ $profilEn->validitas_harga }}"></td>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Proses Manufaktur</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Proses Manufaktur" name="proses_manufaktur" value="{{ $profilEn->proses_manufaktur }}"></td>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Tenaga Kerja</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Tenaga Kerja" name="tenaga_kerja" value="{{ $profilEn->tenaga_kerja }}"></td>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Pendapatan Ekspor</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Pendapatan Ekspor" name="pendapatan_ekspor" value="{{ $profilEn->pendapatan_ekspor }}"></td>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Tujuan Ekspor</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Tujuan Ekspor" name="tujuan_ekspor" value="{{ $profilEn->tujuan_ekspor }}"></td>
                  </tr>
                  <tr>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>Jenis Bisnis Lainnya</strong></td>
                    <td>:</td>
                    <td><input type="text" class="form-control" placeholder="Jenis Bisnis Lainnya" name="jns_bisnis_lain" value="{{ $profilEn->jns_bisnis_lain }}"></td>
                  </tr>
                </tbody>
              </table>
            </div>  
